...
/// The private EA XMI types generated by the XmlProvider type provider
...
let attrToColumnDef (a: EaUml.Attribute) : ColumnDef =
    ...
    let createDataType = DataType.CreateT (name = a.Properties.Type.Value, isAutoNum = isAutoNum,
